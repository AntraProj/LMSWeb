...
const ActiveBoard = () => {
    ...
    const todo:Task[] = mockData.filter(story=>story.status==="todo");
    const inprogress:Task[] = mockData.filter(story=>story.status==="inprogress");
    const done:Task[] = mockData.filter(story=>story.status==="done");
